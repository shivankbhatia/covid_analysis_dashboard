"""
Train severe adverse event prediction model.
"""
import pickle
import duckdb
...
def train_adverse_event_model():
    """Train XGBoost adverse event prediction model."""
    print("Loading features...")
    # TODO: Load features from warehouse
    # Target: adverse_event_score >= 2 (hospitalised or worse)
    ...
    print("Saving model...")
    # model.save_model('adverse_event_xgb.json')
